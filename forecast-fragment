...
public class ForecastFragment extends Fragment {
   ...
   // public List<String> data = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Membuat dummy data untuk ListView
        String[] data = {
        ...
        List<String> weekForecast = new ArrayList<String>(Arrays.asList(data)); //weekForecast = nama dari list data
        ...
        protected String[] doInBackground(String... params) {
            ...
            * These two need to be delared outside the try/catch*/
            ...
            try{
                ...
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=Bandung&mode=json&units=metric&cnt=7&APPID=cc64d5c816f4a01f337640965e71bbbc");

                /* String baseUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Bandung&mode=json&units=metric&cnt=7&APPID=cc64d5c816f4a01f337640965e71bbbc";
